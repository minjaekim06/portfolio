...
function ProjectCard({ p }) {
  return (
    <BackgroundGradient containerClassName="rounded-[1.05rem]" className="rounded-2xl p-0 bg-transparent">
  ...
  return (
    <>
      <ContainerScroll
        titleComponent={
          <>
            <p className="font-mono text-[11px] tracking-[0.16em] uppercase text-cobalt-bright mb-4">Featured</p>
      ...
      >
        <div className="h-full w-full grid place-items-center rounded-2xl bg-[radial-gradient(120%_90%_at_30%_20%,rgba(31,79,255,0.30),transparent_55%),radial-gradient(120%_90%_at_80%_80%,rgba(0,71,171,0.40),transparent_55%),linear-gradient(180deg,#000,#0A0F1F)] relative overflow-hidden">
          ...
          <div className="relative text-center p-8 md:p-16 max-w-2xl">
            <p className="font-mono text-[11px] tracking-[0.16em] uppercase text-cobalt-bright mb-4">Research · 2026</p>
